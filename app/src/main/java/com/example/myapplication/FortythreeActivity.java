...
public class FortythreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fortythree);
    ...
    private void openDatePicker() {
        ...
        materialDatePicker.addOnPositiveButtonClickListener((MaterialPickerOnPositiveButtonClickListener<Long>) selection -> {
            ...
            Log.d("FortythreeActivity", "Selected start date: " + formattedDate);
        ...
        protected void onPostExecute(List<String[]> csvData) {
            if (csvData != null && !csvData.isEmpty()) {
                if (csvData.size() > 1) {
                    ...
                    Toast.makeText(FortythreeActivity.this, "No data found for the selected date range", Toast.LENGTH_SHORT).show();
                }
            }  else {
                Toast.makeText(FortythreeActivity.this, "Failed to download or parse CSV file", Toast.LENGTH_SHORT).show();
            }
        }
    }
