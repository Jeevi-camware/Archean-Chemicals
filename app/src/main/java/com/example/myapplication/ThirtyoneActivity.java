...
public class ThirtyoneActivity extends AppCompatActivity {
    ...
    private void openDatePicker() {
        ...
        materialDatePicker.addOnPositiveButtonClickListener((MaterialPickerOnPositiveButtonClickListener<Long>) selection -> {
            ...
            Log.d("ThirtyoneActivity", "Selected start date: " + formattedDate);
        ...
        protected void onPostExecute(List<String[]> csvData) {
            if (csvData != null && !csvData.isEmpty()) {
                if (csvData.size() > 1) {
                    ...
                    Toast.makeText(ThirtyoneActivity.this, "No data found for the selected date range", Toast.LENGTH_SHORT).show();
                }
            }  else {
                Toast.makeText(ThirtyoneActivity.this, "Failed to download or parse CSV file", Toast.LENGTH_SHORT).show();
            }
        }
    }
