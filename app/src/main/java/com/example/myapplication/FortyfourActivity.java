...
public class FortyfourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fortyfour);
    ...
    private void openDatePicker() {
        ...
        materialDatePicker.addOnPositiveButtonClickListener((MaterialPickerOnPositiveButtonClickListener<Long>) selection -> {
            ...
            Log.d("FortyfourActivity", "Selected start date: " + formattedDate);
        ...
        protected void onPostExecute(List<String[]> csvData) {
            if (csvData != null && !csvData.isEmpty()) {
                if (csvData.size() > 1) {
                    ...
                    Toast.makeText(FortyfourActivity.this, "No data found for the selected date range", Toast.LENGTH_SHORT).show();
                }
            }  else {
                Toast.makeText(FortyfourActivity.this, "Failed to download or parse CSV file", Toast.LENGTH_SHORT).show();
            }
        }
    }
